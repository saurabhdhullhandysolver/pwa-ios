...
let rootUrl = URL(string: "https://handysolver.myhandydash.com/backend/pages/react-views/build/?source=pwa")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["handysolver.myhandydash.com"]
